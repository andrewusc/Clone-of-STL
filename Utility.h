...
namespace TinySTL{
    ...
    public:
        ...
        friend bool operator>=(const pair<T1,T2>& lhs, const pair<T1,T2>& rhs);
        //template<class T1, class T2>
        friend bool swap(pair<T1,T2>& x, pair<T1,T2>& y);
    ...
    template<class T1, class T2>
    bool operator<(const pair<T1,T2>& lhs, const pair<T1,T2>& rhs){
        return lhs.first < rhs.second || (!(lhs.first < rhs.first) && lhs.second < rhs.second);
    }
    ...
    template<class T1, class T2>
    void swap(const pair<T1,T2>& x, const pair<T1,T2>& y){
        x.swap(y);
    }
